...
\title{Fixed Income}
\author{杨弘毅}
\date{创建: 2021 年 9 月 5 日 \\修改: \today}
\begin{document}
\maketitle
...
\begin{figure}[ht!]
	\centering
	\includegraphics{fig/factor_loading.png}
	\caption{主成分因子载荷}
\end{figure}
...
\begin{figure}[ht!]
	\centering
	\includegraphics{fig/runges_phenomenon.png}
...
\begin{figure}[ht!]
	\centering
	\includegraphics{fig/spline.png}
	\caption{木质样条}
\end{figure}
...
\begin{figure}[ht!]
	\centering
	\includegraphics[width=0.4\textwidth]{fig/hermite_spline.png}
