...
\usepackage{cancel}
\usepackage{enumitem}
\usepackage{multicol,makecell,array}
\usepackage{graphicx}
...
\newcommand{\rnE}{\mathbb{E}^{\mathbb{Q}}}
\newcommand{\wt}[1]{\widetilde{#1}}
\newcommand{\abs}[1]{\left\lvert #1\right\rvert}
\newcommand{\norm}[1]{\left\lVert #1\right\rVert}
\newcommand{\given}{\:\vert\,}
\newcommand{\ilsep}{,\;} %inline separation
\newcommand{\eqsep}{\;,\quad} %equation separation
\newcommand{\code}[1]{\texttt{#1}} % 与\verb|some_code|相同
