...
那么对于商品期货而言：
\begin{itemize}
    \item 负基差：期货价格高于现货价格，净持仓成本为正，期货升水（Contango，支付交易延期费）。此时的市场被称之为正向市场或正常市场（Normal market），即期限较短的合约价格（Near-maturity contract）低于期限较远的合约（Far-maturity contract）。由于大多数\uline{商品期货储藏成本较大，大于便利收益，使得期货升水}，因此称为正向市场。
    \item 正基差：期货价格低于现货价格，净持仓成本为负，期货贴水（Backwardation）。此时的市场称为逆向市场（Inverted market），即期限较短合约的价格高于期限较远的合约。
...
对于商品期货，便利收益指实际持有持有现货带来的收益，如工厂用于生产的需求，即对现货的需求程度\uline{与预期有关}。当对现货需求越大，现货越贵，此时便利收益越高。便利收益为随机变量，且取决于短期内的供求关系。作为原油而言，当国际形势紧张，此时便利收益远大于储藏成本，因此此时现货价格将大于期货价格。相反，当疫情发生，全球工厂停工，因此原油带来的便利收益很低，储藏成本大于便利收益，此时原油期货价格大于现货价格。在负油价事件中，出现负油价的是马上要交割的期货，其价格实质为现货价格，而其他合约的原油期货都为正。交割期货时，多头无法找到储油设施存入原油，使得短期内储藏成本大幅上涨，导致现货价格为负。期货贴水，说明现货的供应越紧张。相反，期货升水，说明现货供应充足。因此，此时期货与现货价格的关系（升贴水），体现了短期内现货供求关系的预期，即投资者对\uline{未来的预期}。并且由于便利收益的主观性，无套利条件被打破。此时也可以将便利收益，放入做空成本中考虑，即不愿意放弃现货，所支付的成本，因此应有$F_{t,T}< S e^{r(T-t)}$。
...
\begin{gather*}
    ...
    \log(F_{F/L}) \approx \log(S_{F/L}) + i_L - i_F 
\end{gather*}
