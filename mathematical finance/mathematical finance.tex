...
\begin{note}
    关于收益率的计算：
    \begin{itemize}
        \item 收益率需要使用后复权价格进行计算，与真实收益率不不相等但近似
        \item 使用不复权价格，使用当天的”PreClose“或“昨收”字段（为经过除权）与当天收盘价格计算的收益率
...
USD/CNY约为6.7，即美元兑人民币为6.7，从字面理解即1美金（每美金），兑换6.7人民币，也可称为CNY per USD。也经常表示为USDCNY或USD：CNY，称为USD to CNY或USD against CNY。在前的货币称为Base currency（每），在后的称为Quote currency或称为Local currency。
...
两国利差，如中国名义（Nominal）利率为3\%，而美国利率为1\%，那么应该卖出美金，买入人民币，投资中国债券，从而赚取利差。那么未来应该人民币贬值2\%，或美元兑人民币升值2\%，不然就存在套利机会。即投资高利率国所获得的额外收益，将由该国汇率贬值抵消。
