...
USD/JPY约为136，即1美元兑换136日元。USD/CNY约为6.7，即美元兑人民币为6.7。或表示为USDCNY或USD：CNY，称为USD to CNY或USD against CNY。比值的形式有：
\begin{equation*}
    \text{USD/CNY} = \frac{6.7}{1} = \frac{\text{CNY}}{\text{USD}}
\end{equation*}

Base currency在前，为在外汇交易中买入的货币。Quote currency在后，或称为Local currency，为在外汇交易中卖出的货币。显然此时有USD作为分母称为Base currency，而CNY作为分子为Quote currency。如果做多USD/CNY，那么即希望Base currency USD涨，从而获利，若做空USD/CNY，那么希望USD跌。若将苹果作为一种货币，假设苹果价格为2元/个或$\frac{\text{人民币}}{\text{苹果}}= \frac{2}{1}$，即有苹果：人民币为2。做多苹果，那么希望base currency涨价，即苹果涨价。此时人民币为Local currency，即希望卖出的品种，买入苹果。
