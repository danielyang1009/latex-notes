...
因此，当金融期货贴水，即期货价格小于现货价格，称有负基差。而金融期货升水，或期货价格大于现货价格，称有正基差。在中国市场中，在股指期货中一般存在期货贴水的现象，即现货价格$S_t$大于期货价格$F_t$（期货贴水），现货价格被高估。这是由于现货做空机制不完善，很难进行融券，即使能融券成本也较高。使得套利投资者在现货被高估的情况下，难以通过卖出现货（卖出开仓）买进期货进行\textbf{反向套利}（Reversed cash and carry arbitrage；买入现货卖出期货为\textbf{正向套利}）。造成现货与期货市场的分割，无法达到一体化的预期。另外由于买卖现货需要交纳印花税，而期货不需要，且期货佣金往往低于现货。
